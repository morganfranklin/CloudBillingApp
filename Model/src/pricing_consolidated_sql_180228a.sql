...
CASE WHEN C.XPE_PERIOD_TYPE ='EVE' THEN 1 ELSE C.XPE_RATE END,--- 180127 A.CIS_TRANS_BI_AMT2,
...
UPDATE XPE_DCC_CFG_PCSSHORTNAMES  B SET B.CREDIT_STATUS = 
(SELECT MAX(A.CREDIT_STATUS) FROM XPE_DCC_CREDIT_VW2  A
WHERE B.COV_BILL_ID = A.CUST_ID) WHERE EXISTS
