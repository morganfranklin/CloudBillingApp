...
// ---    Thu Feb 01 03:01:01 EST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XpeDccTermsContractEOImpl extends EntityImpl {
    /**
    ...
    public static final int XPEDCCCONTRACTVERSION1 = AttributesEnum.XpeDccContractVersion1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public XpeDccTermsContractEOImpl() {
    }
    ...
    /**
     * Gets the attribute value for XpeDccContractId, using the alias name XpeDccContractId.
     * @return the value of XpeDccContractId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for XpeDccContractId.
     * @param value value to set the XpeDccContractId
     */
    ...
    /**
     * Gets the attribute value for XpeDccContractVersion, using the alias name XpeDccContractVersion.
     * @return the value of XpeDccContractVersion
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for XpeDccContractVersion.
     * @param value value to set the XpeDccContractVersion
     */
     ...
     */
    public XpeDccContractVersionImpl getXpeDccContractVersion1() {
        return (XpeDccContractVersionImpl) getAttributeInternal(XPEDCCCONTRACTVERSION1);
    }

    /**
     * Sets <code>value</code> as the associated entity model.XpeDccContractVersionImpl.
     */
    public void setXpeDccContractVersion1(XpeDccContractVersionImpl value) {
        setAttributeInternal(XPEDCCCONTRACTVERSION1, value);
    }

    /**
     * @param xpeDccClause key constituent
     * @param xpeDccContractId key constituent
     * @param xpeDccContractVersion key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String xpeDccClause, String xpeDccContractId, String xpeDccContractVersion) {
        return new Key(new Object[] { xpeDccClause, xpeDccContractId, xpeDccContractVersion });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.entities.XpeDccTermsContractEO");
    }
