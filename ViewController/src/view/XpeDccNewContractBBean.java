...
public class XpeDccNewContractBBean {
    ...
    public void setProfileWasteApprovalInputText(RichInputText profileWasteApprovalInputText) {
        this.profileWasteApprovalInputText = profileWasteApprovalInputText;
    }
